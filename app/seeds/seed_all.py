...
def seed_all():
    ...
    sharon = User(
        first_name='Sharon', last_name='Fang', email='sharon@aa.io', password='password', channels=[channel1, channel_aa], image_url='https://media.licdn.com/dms/image/C5603AQFbL2uEiU7GRA/profile-displayphoto-shrink_800_800/0/1651377972085?e=1680134400&v=beta&t=Jr8CevI6I6zOGepvKOVSe-x-TIx4Zynno-KRGhfZZj8')
    gabriel = User(
